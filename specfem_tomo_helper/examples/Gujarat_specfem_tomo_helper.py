...
path = '../data/DBRD-NATURE2020-depth.r0.1.nc'

if not os.path.isfile(path):
    subprocess.call(['wget', '-P', '../data/', 'http://ds.iris.edu/files/products/emc/emc-files/DBRD-NATURE2020-depth.r0.1.nc'])
...
myProj = define_utm_projection(42, 'N')
